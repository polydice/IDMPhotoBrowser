...
- (id)init {
    if ((self = [super init])) {
        ...
        if(kUSE_CURRENT_CONTEXT_PRESENTATION_STYLE) _applicationRootViewController.modalPresentationStyle = UIModalPresentationFullScreen;
...
- (void)viewDidLoad {
    ...
    // View
	self.view.backgroundColor = _applicationWindow.backgroundColor = [UIColor colorWithWhite:(_useWhiteBackgroundColor ? 1 : 0) alpha:1];
